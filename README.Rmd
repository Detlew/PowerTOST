...
The package contains functions to calculate power and estimate sample size for various study designs used in (not only bio-) equivalence studies. Built with R `r getRversion()`.
...
### Power Analysis
Target power 0.80, minimum acceptable power 0.70. *θ*<sub>0</sub>, design, conditions, and sample size method dependent on defaults of the respective approaches (ABE, ABEL, RSABE, NTID).
...
Sample size assuming heteroscedasticity (*CV<sub>wT</sub>* 0.15, *CV<sub>wR</sub>* 0.10). Assess additionally which one of the three conditions (scaled, ABE, *s<sub>wT</sub>*/*s<sub>wR</sub>* ratio) drives the sample size.
