...
#### ABEL
\"2x2x4\" full replicate design (TRTR|RTRT), homogenicity (*CV<sub>wT</sub>* = *CV<sub>wR</sub>* 0.45). Sample sizes and achieved power for the supported methods (‘key’ statistics or subject simulations).
```{r, echo = FALSE}
