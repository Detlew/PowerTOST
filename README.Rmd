...
Sample size for assumed within- (intra-) subject *CV* 0.125 (12.5\%), *θ*~0~ 0.975. Acceptance range for <span title="Narrow Therapeutic Index Drugs">NTIDs</span> (many jurisdictions).
```{r crossover_ABE3}
