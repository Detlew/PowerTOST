...
```
![**Fig. 5** Power Analysis (in each panel one argument is varied and others kept constant)](figure13.png){width=469px}
...
```
![**Fig. 6** Power Analysis (in each panel one argument is varied and others kept constant)](figure10.png){width=469px}
...
pa.NTIDFDA(CV = 0.125)
```
![**Fig. 7** Power Analysis (in each panel one argument is varied and others kept constant)](figure11.png){width=469px}
