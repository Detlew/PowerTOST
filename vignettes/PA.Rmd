...
If no addtional arguments are passed, the defaults of `power.TOST()` are applied, namely `alpha=0.05`, `theta1=0.80`, `theta2=1.25`. Note that analysis of untransformed data (`logscale=FALSE`) is not supported.
...
[Example 3 of vignette ABE](ABE.html#expl3). Assumed $\theta_{0}$ 0.92, *CV* 0.20, all defaults employed.
```{r}
