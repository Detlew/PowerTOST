...
<h3>Details and examples are accessible via the menu bar on top of the page and<br>the [online manual](https://cran.r-project.org/package=PowerTOST/PowerTOST.pdf "PDF") of all functions.</h3>
