...
# Skipping install of 'PowerTOST' from a github remote, the SHA1 (eb75b9b)
# has not changed since last install.
# Use `force = TRUE` to force installation
```
For speed reasons this call will *not* (re)build the package vignettes. If you want them call
```
...
# Use `force = TRUE` to force installation
```
Be patient. Building the vignettes will take a couple of minutes.
