...
Rather extreme: Five levels, but we want only three periods. Hence, we opt for an incomplete block design. The design matrix is obtained from the library `crossdes`.
```{r}
levels <- 5
doses  <- mod.fibo(lowest, levels)
