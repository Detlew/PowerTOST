...
data frame<small> </small>^[R Documentation. *Data Frames.* 2022-02-08. [R-manual](https://stat.ethz.ch/R-manual/R-devel/library/base/html/data.frame.html).] with nine columns `Design`, `alpha`, `CV`, `theta0`, `theta1`, `theta2`, `Sample size`, `Achieved power`, and `Target power`.\
...
expsampleN.TOST(CV = 0.20, theta0 = 0.92, prior.type = "both",
                ...
                details = FALSE)
```
This sample size is almost twice the 28 your boss got from his/her Excel-Sheet.<small> </small>^[Dubins D. *My Tiny Contribution to Clinical Research: FARTSSIE.* 2021-03-21. [FARTSSIE](https://github.com/dndubins/FARTSSIE).] If you are not fired right away when suggesting such a study, take it as a warning what *might* happen.\
...
> `r tufte::quote_footer('--- Donald J. Schuirmann (2004)^[Schuirmann DJ. *Two at a Time? Or All at Once?* [online](https://www.enar.org/meetings/meetings2004/enar_final_program_2004.pdf#page=204).]')`
