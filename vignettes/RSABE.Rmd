...
# Warning: 'sampleN.NTIDFDA' is deprecated.
# Use 'sampleN.NTIDRSABE' instead.
# See help("Deprecated")
# Error in sampleN.NTIDRSABE(...): could not find function "sampleN.NTIDRSABE"
suppressMessages(power.NTIDFDA(CV = CV, n = n, details = TRUE))
# Error in power.NTIDFDA(CV = CV, n = n, details = TRUE): object 'n' not found
```
...
# License{#license}
<h4 class="author">[GPL-3](https://cran.r-project.org/web/licenses/GPL-3 "GNU General Public License, Version 3") 2022-02-16 Helmut Schütz</h4>
