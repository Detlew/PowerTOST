...
| $\small{\theta_{0}}$ | `theta0` | ‘True’ or assumed T/R ratio | `0.90` |
| $\small{\theta_{1}}$ | `theta1` | Lower BE limit and PE constraint | `0.80` |
| $\small{\theta_{2}}$ | `theta2` | Upper BE limit and PE constraint | `1.25` |
| *CV* | `CV` | CV | none |
...
# License{#license}
<h4 class="author">Helmut Schütz 2020-08-08</h4>
