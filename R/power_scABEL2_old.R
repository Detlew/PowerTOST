...
power.scABEL2.old <- function(alpha=0.05, theta1, theta2, theta0, CV, n,   
                          ...
                          nsims=1E5, details=FALSE, setseed=TRUE)
{
  ...
  p <- .pwr.ABEL.ISC.old(mlog, sdm, C3, Emse, df, s2wR, dfRR, nsims, 
...
# working horse
.pwr.ABEL.ISC.old <- function(mlog, sdm, C3, Emse, df, s2wR, dfRR, nsims, 
