...
# small CV correction of the ABE contribution (CV<0.25)
power.scABEL1a <- function(alpha=0.05, theta1, theta2, theta0, CV, n,   
                          ...
                          nsims=1E5, details=FALSE, setseed=TRUE)
{
  ...
  p <- .pwr.ABEL.ANOVA.1a(mlog, sdm, Ccon=C2, Emse, cvec, df, s2wR, dfRR, s2wT, dfTT, 
...
.pwr.ABEL.ANOVA.1a <- function(mlog, sdm, Ccon, Emse, cvec, df, s2wR, dfRR, s2wT, dfTT, 
                            design, nsims, CVswitch, r_const, CVcap, pe_constr, 
